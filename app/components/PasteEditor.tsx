...
export default function PasteEditor() {
  ...
  return createdPaste ?
    (<div className="flex flex-col gap-4 items-center">
      ...
      <CodeViewer title={createdPaste.title} language={createdPaste.language || undefined} text={createdPaste.content} />
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col sm:flex-row justify-end gap-2">
          ...
          >
            ...
            <Button className="inline-block cursor-pointer min-w-40 flex justify-center" onClick={handleSubmit}>
